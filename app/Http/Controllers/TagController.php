...
class TagController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:tag_create', ['only' => ['creat', 'store']]);
    ...
    public function select(Request $request)
    {
        ...
        if ($request->has('q')){
            ...
            $tags = Tag::select('id','title')->limit(10)->get();
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Alert::error(
                trans('tags.alert.create.title'),
                trans('tags.alert.create.message.error', ['error'=>$ex->getMessage()])
            );
    ...
    public function update(Request $request, Tag $tag)
    {
        ...
        try {
            ...
            Alert::error(
                trans('tags.alert.update.title'),
                trans('tags.alert.update.message.error', ['error'=>$ex->getMessage()])
            );
    ...
    public function destroy(Tag $tag)
    {
        try {
            $tag->delete();
            Alert::success(trans('tags.alert.delete.title'), trans('tags.alert.delete.message.success'));
        }catch (\Exception $ex){
            Alert::error(trans('tags.alert.delete.title'), trans('tags.alert.delete.message.error', ['error' => $ex->getMessage()]));
        }
