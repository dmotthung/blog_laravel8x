...
class PostController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:post_create', ['only' => ['creat', 'store']]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Alert::error(
                trans('posts.alert.create.title'),
                trans('posts.alert.create.message.error', ['error' => $ex->getMessage()])
            );
            if ($request['tag']) {
                $request['tag'] = Tag::select('id', 'title')->whereIn('id', $request->tag)->get();
            }
    ...
    public function update(Request $request, Post $post)
    {
        ...
        try {
            ...
            Alert::error(
                trans('posts.alert.update.title'),
                trans('posts.alert.update.message.error', ['error' => $ex->getMessage()])
            );
            if ($request['tag']) {
                $request['tag'] = Tag::select('id', 'title')->whereIn('id', $request->tag)->get();
            }
    ...
    public function destroy(Post $post)
    {
        ...
        try {
            ...
            Alert::error(
                trans('posts.alert.delete.title'),
                trans('posts.alert.delete.message.error', ['error' => $ex->getMessage()])
            );
        } finally {
            DB::commit();
